...
export function CatchBoundary() {
	...
	switch (caught.status) {
		...
		case 404: {
			return <div className='error-container'>Huh? What the heck is {params.gameId}?</div>;
		}
		case 401: {
			return <div className='error-container'>Sorry, but {params.gameId} is not your game.</div>;
		}
		default: {
